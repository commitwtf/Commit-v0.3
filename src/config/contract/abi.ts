export const COMMIT_ABI_V04 = [
  ...
  {
    type: 'function',
    name: 'createCommitmentNativeToken',
    inputs: [
      {
        name: '_creatorFee',
        type: 'uint256',
    ...
    outputs: [
      {
        name: '',
        type: 'tuple',
        internalType: 'struct Storage.Claims',
        components: [
          {
            name: 'winnerClaim',
            type: 'uint256',
    ...
    outputs: [
      {
        name: '',
        type: 'tuple',
        internalType: 'struct Storage.CommitmentInfo',
        components: [
          {
            name: 'id',
            type: 'uint256',
  ...
  {
    type: 'function',
    name: 'resolveCommitmentDisperse',
    inputs: [
      {
        name: '_id',
        type: 'uint256',
  ...
  {
    type: 'function',
    name: 'resolveCommitmentMerklePath',
    inputs: [
      {
        name: '_id',
        type: 'uint256',
  ...
  {
    type: 'error',
    name: 'InvalidFullfillmentDeadline',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'NoCreatorFeesToClaim',
    inputs: [],
  },
  {
    type: 'error',
    name: 'NoProtocolFeesToClaim',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'OnlyCreatorCanClaim',
    inputs: [],
  },
  {
    type: 'error',
    name: 'OnlyCreatorCanResolve',
    inputs: [],
  },
  {
    type: 'error',
    name: 'OnlyCreatorOrOwnerCanCancel',
    inputs: [],
  },
  {
    type: 'error',
    name: 'OnlyCreatorOrOwnerCanUpdateURI',
    inputs: [],
  },
  {
    type: 'error',
