				...
				<div className="p-4 flex flex-col items-center">
					<div className="flex items-center space-x-4 mb-2">
						<Link href="https://x.com/commitwtf" target="_blank" rel="noopener noreferrer">
							<Button variant="ghost" size="icon" className="rounded-lg text-gray-900 dark:text-[#E0E0E0] hover:bg-[#DCDCDC] hover:text-gray-900">
								<span className="sr-only">Twitter</span>
								X
							</Button>
						</Link>
						<Link href="https://warpcast.com/~/channel/commit" target="_blank" rel="noopener noreferrer">
							<Button variant="ghost" size="icon" className="rounded-lg text-gray-900 dark:text-[#E0E0E0] hover:bg-[#DCDCDC] hover:text-gray-900">
								<span className="sr-only">Farcaster</span>
								<svg className="w-5 h-5" viewBox="0 0 1000 1000" fill="none" xmlns="http://www.w3.org/2000/svg">
