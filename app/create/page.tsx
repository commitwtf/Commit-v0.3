						...
						<form className="space-y-6">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
								<div>
									...
									<Input id="deadline" type="datetime-local" className="w-full bg-[#DCDCDC] text-gray-900 border-gray-300 dark:border-gray-700" />
								</div>
								<div>
									<label htmlFor="creatorFee" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Creator Fee</label>
									<Input id="creatorFee" type="number" min="0" step="0.01" placeholder="1" className="w-full bg-[#DCDCDC] text-gray-900 border-gray-300 dark:border-gray-700" />
								</div>
								<div>
									<label htmlFor="commitStake" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Commit Stake</label>
									<Input id="commitStake" type="number" min="0" step="0.01" placeholder="10" className="w-full bg-[#DCDCDC] text-gray-900 border-gray-300 dark:border-gray-700" />
								</div>
							</div>
